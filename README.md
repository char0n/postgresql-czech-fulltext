...
services:
  postgres:
    container_name: postgres-14beta3-czech
    image: char0n/postgresql-czech-fulltext:14beta3
    ports:
     - "5432:5432"
    environment:
...
```bash
 $ docker exec -it postgres-14beta3-czech psql -U postgres -d example_database
```
